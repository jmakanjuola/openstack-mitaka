...
Vagrant.configure(2) do |config|
  ...
  config.vm.define "control", primary: true do |h|
    h.vm.network "private_network", ip: "192.168.150.20"
...
EOF
  ...
  config.vm.define "controller" do |h|
    h.vm.network "private_network", ip: "192.168.150.110"
    h.vm.provision :shell, inline: 'cat /vagrant/control.pub >> /home/vagrant/.ssh/authorized_keys'
  end

  config.vm.define "compute" do |h|
    h.vm.network "private_network", ip: "192.168.150.120"
    h.vm.provision :shell, inline: 'cat /vagrant/control.pub >> /home/vagrant/.ssh/authorized_keys'
  end
